...
function uploader(selector, options) {
  ...
  if (options.onBeforeQueued) {
    ...
    options.onBeforeQueued = (file, files) => {
  ...
  if (options.onBeforeSend) {
    ...
    options.onBeforeSend = (file, data, headers) => {
  ...
  $uploader.find('input[type="file"]').on('change', (evt) => {
